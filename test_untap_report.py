    ...
    def test_cli_html_flag_writes_report_after_batch(self):
        ...
        try:
            ...
            with mock.patch.object(sys, "argv", ["untap.py", "--menu", menu.name, "--html"]), \
                 ...
                 mock.patch.object(untap, "save_snapshot"), \
    ...
    def test_cli_report_title_is_forwarded_to_html_renderer(self):
        ...
        try:
            ...
            with mock.patch.object(
                ...
                untap, "save_csv"
            ), mock.patch.object(untap, "save_snapshot"), mock.patch.object(untap, "create_run_directory", return_value=Path("test-run")), mock.patch.object(untap, "save_html_report") as save_report:
                untap.main()
